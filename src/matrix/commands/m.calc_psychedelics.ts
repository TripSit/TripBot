...
async function mCalcPsychedelics(roomId:string, event:any, client:MatrixClient, substance:string = '', lastDose:string = '', days:string = '', desiredDose:string = ''):Promise<boolean> {
