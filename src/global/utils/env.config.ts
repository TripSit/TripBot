...
export const env = {
  ...
  ROLE_ANNOUNCEMENTS: isProd ? '1079979922321330196' : '1066606644978532372',
  ROLE_TRIPBOTUPDAES: isProd ? '1079979930353418260' : '1070227886625259623',
  ROLE_TRIPTOWNNOTICES: isProd ? '1079979933247488090' : '1071809618239557703',
  ...
  ROLE_TTS_DRUNK: isProd ? '955485069294854154' : '1052644628639252500',
  ROLE_TTS_HIGH: isProd ? '955482289335320626' : '1052644630912577586',
  ROLE_TTS_ROLLING: isProd ? '955485203592261633' : '1052644633492082819',
  ROLE_TTS_TRIPPING: isProd ? '955485936915980348' : '1052644632409935872',
  ROLE_TTS_DISSOCIATING: isProd ? '955485314305101874' : '1052644634460963038',
  ROLE_TTS_STIMMING: isProd ? '955485549035126815' : '1052644635559870525',
  ROLE_TTS_SEDATED: isProd ? '955485615879749682' : '1052644636511965184',
  ROLE_TTS_SOBER: isProd ? '955486188268056656' : '960606558071435317',
  ROLE_TTS_TALKATIVE: isProd ? '981437055030677554' : '1052644638487486464',
  ROLE_TTS_WORKING: isProd ? '955486102549049344' : '1052644637380190268',
  ...
  EMOJI_BACKGROUND: isProd ? '🖼' : '<:itemBackground:1080407229389340732>',
  EMOJI_MULTIPLIER: isProd ? '🔥' : '<:itemMultiplier:1080455974948720670>',
  EMOJI_TOWN: isProd ? '🏘️' : '<:buttonTown:1080407223978692648>',
  EMOJI_WORK: isProd ? '👷' : '<:buttonWork:1080407301552353351>',
  EMOJI_SHOP: isProd ? '🛒' : '<:buttonShop:1080407342908199042>',
  ...
  EMOJI_INVENTORY: isProd ? '🎒' : '<:buttonInventory:1080450532218523648>',
  EMOJI_QUEST: isProd ? '🗺️' : '<:buttonQuest:1080407212142374922>',
  EMOJI_DUNGEON: isProd ? '🏰' : '<:buttonDungeon:1080407205389541426>',
  EMOJI_RAID: isProd ? '👹' : '<:buttonRaid:1080407215007084586>',
  EMOJI_BUY: isProd ? '🛒' : '<:buttonBuy:1080407200217960478>',
  EMOJI_COINFLIP: isProd ? '🪙' : '<:buttonCoinflip:1080407202268971008>',
  EMOJI_ROULETTE: isProd ? '🎲' : '<:buttonRoulette:1080407217104228382>',
  EMOJI_ROWS: isProd ? '🎰' : '<:buttonRows:1080465578105511956>',
  EMOJI_HALF: isProd ? '🎰' : '<:buttonHalf:1080464998612090891>',
  EMOJI_UPDOWN: isProd ? '🎰' : '<:buttonUpDown:1080467816878198794>',
  EMOJI_TRIVIA: isProd ? '' : '<:buttonTrivia:1080407316492472340>',
  EMOJI_BETSMALL: isProd ? '🪙' : '<:buttonBet:1080407188188692551>',
  EMOJI_BETMEDIUM: isProd ? '🪙' : '<:buttonBet:1080407186418704394>',
  EMOJI_BETLARGE: isProd ? '🪙' : '<:buttonBet:1080407183474294834>',
  EMOJI_BETHUGE: isProd ? '🪙' : '<:buttonBet:1080407181595258930>',
  EMOJI_HEADS: isProd ? '🗿' : '<:buttonHeads:1080407207205687327>',
  EMOJI_TAILS: isProd ? '🐍' : '<:buttonTails:1080407221017522176>',
  EMOJI_EASY: isProd ? '🟢' : '<:menuEasy:1080466045942374440>',
  EMOJI_NORMAL: isProd ? '🟢' : '<:menuNormal:1080356204963967039>',
  EMOJI_HARD: isProd ? '🟡' : '<:menuHard:1080356203307212811>',
  EMOJI_EXPERT: isProd ? '🔴' : '<:menuExtreme:1080356200325074954>',
  EMOJI_SHORT: isProd ? '🟢' : '<:menuShort:1080359221905862716>',
  EMOJI_MEDIUM: isProd ? '🟡' : '<:menuMedium:1080359234081935370>',
  EMOJI_LONG: isProd ? '🔴' : '<:menuLong:1080359249168834600>',
  EMOJI_BUTTON_A: isProd ? 'A' : '<:buttonBoxA:1080407191439282216>',
  EMOJI_BUTTON_B: isProd ? '🇧' : '<:buttonBoxB:1080407193075056710>',
  EMOJI_BUTTON_C: isProd ? '🇨' : '<:buttonBoxC:1080407195826536459>',
  EMOJI_BUTTON_D: isProd ? '🇩' : '<:buttonBoxD:1080407197579739157>',
};
