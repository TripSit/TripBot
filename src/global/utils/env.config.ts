...
export const env = {
  ...
  CATEGROY_HARMREDUCTIONCENTRE: isProd ? '848555446394552370' : '1052634083760554035',
  ...
  CATEGORY_CAMPGROUND: isProd ? '848731346959335445' : '1052634085803180062',
  // CHANNEL_GENERAL: isProd ? '538811092084850708' : '1052634155827073114',
  ...
  CATEGORY_BACKSTAGE: isProd ? '992484502909747230' : '1052634087753519154',
  ...
  CHANNEL_OPIATES: isProd ? '992134995625922620' : '1052634185149456394',
  ...
  ROLE_VIP_5: isProd ? '1007115915734831185' : '1052644658565623848',
  ...
  ROLE_GREEN: isProd ? '957299256941740072' : '1052644683383328798',
  ROLE_BLUE: isProd ? '957299516833411163' : '1052644682213097593',
  ROLE_YELLOW: isProd ? '957299118546518017' : '1052644676349476927',
  ROLE_PURPLE: isProd ? '957299595644403772' : '1052644684473839746',
  ...
  ROLE_PINK: isProd ? '958073126485368922' : '1052644685396578345',
