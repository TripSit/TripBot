...
export const env = {
  ...
  EMOJI_ARCADE: isProd ? '🎮' : '<:buttonArcade:1080407178118176768>',
  EMOJI_START: isProd ? '🏁' : '<:buttonStart:1080411081412980736>',
  EMOJI_QUIT: isProd ? '🛑' : '<:buttonQuit:1080411092452380705>',
  EMOJI_HOME: isProd ? '🛖' : '<:buttonHome:1080407210372378654>',
