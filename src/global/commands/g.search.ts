...
export async function normalDefine(term: string): Promise<{
...
export async function steam(query: string): Promise<{
  title: string,
  url: string,
  description: string,
  thumb: string,
...
export async function wikipedia(query: string): Promise<{
  title: string, url: string, description: string, thumb: string
}> {
...
export async function weather(city: string): Promise<{
  title: string,
  url: string,
  description: string,
  fields: { name: string, value: string, inline?: boolean }[]
