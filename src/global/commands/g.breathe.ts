...
export async function breathe(choice:string | null):Promise<string> {
  ...
  if (choice === '2') response = 'https://i.imgur.com/XbH6gP4.gif'; // Balls
  if (choice === '3') response = 'https://i.imgur.com/g57i96f.gif'; // Circle
  if (choice === '4') response = 'https://i.imgur.com/MkUcTPl.gif'; // Hedgehog
