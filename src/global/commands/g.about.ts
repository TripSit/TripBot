...
export default class About {
  ...
  public static readonly inviteUrl: string =
    'https://discord.com/api/oauth2/authorize?client_id=957780726806380545&permissions=18432&scope=bot%20applications.commands';
  ...
  public static readonly tripsitSessionsCourse: string =
    'https://learn.tripsit.me/mod/lesson/view.php?id=24';
