...
import { tripsitMemberRemove } from '../commands/guild/d.tripsit';
...
export const guildMemberRemove: GuildMemberRemoveEvent = {
  ...
  async execute(member) {
    ...
    // Send log messages of the user leaving the guild
    if (guildData.channel_mod_log || targetData.mod_thread_id) {
    ...
    if (sessionData) {
      await tripsitMemberRemove(member);
    }
  },
};
