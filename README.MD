...
| Scenario                               | Behaviour                          |
|----------------------------------------|------------------------------------|
| Key in en-US missing from other locale | Added with empty string            |
| Key removed from en-US                 | Removed from other locales         |
| Key order differs from en-US           | Reordered to match                 |
| Namespace file missing from a locale   | Created with all keys empty        |
| Existing non-empty translation         | Preserved, never overwritten       |

```npm run i18n:sync```         # apply
```npm run i18n:sync -- --dry`  # preview